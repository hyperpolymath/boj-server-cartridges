...
# Integration tests for github-api-mcp cartridge.
set -euo pipefail
...
echo "=== github-api-mcp integration tests ==="
...
if command -v idris2 &>/dev/null; then
    cd "$CART_DIR/abi" && idris2 --check GithubApiMcp.SafeCloud 2>&1
    echo "  ABI: OK"
else
...
echo ""
echo "All tests passed for github-api-mcp!"
