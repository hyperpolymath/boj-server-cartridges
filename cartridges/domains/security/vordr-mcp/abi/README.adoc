...
= vordr-mcp / abi — Idris2 ABI layer
:orientation: shallow

== Purpose

Cartridge-local protocol types for `vordr-mcp`. Defines the data, tool, and
...
1 Idris2 module(s), ~62 lines total. Lead module:
`SafeVordr.idr`.
...
. `SafeVordr.idr` — cartridge-local data records and enums.
