...
= digitalocean-mcp / abi — Idris2 ABI layer
:orientation: shallow

== Purpose

Cartridge-local protocol types for `digitalocean-mcp`. Defines the data, tool, and
...
1 Idris2 module(s), ~224 lines total. Lead module:
`SafeCloud.idr`.
...
. `SafeCloud.idr` — cartridge-local data records and enums.
