...
pub fn build(b: *std.Build) void {
    ...
    adapter_mod.addImport("game_admin_ffi", ffi_mod);
    ...
    const run_step = b.step("run", "Run the game-admin-mcp adapter");
    ...
    const test_step = b.step("test", "Run game-admin-mcp adapter tests");
