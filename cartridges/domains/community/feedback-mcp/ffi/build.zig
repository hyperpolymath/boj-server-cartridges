...
//
// Feedback-MCP Cartridge — Zig FFI build configuration (Zig 0.15+).
...
pub fn build(b: *std.Build) void {
    ...
    const run_tests = b.addRunArtifact(fb_tests);

    const test_step = b.step("test", "Run feedback-mcp FFI tests");
