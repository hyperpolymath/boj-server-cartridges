...
const REST_PORT: u16 = 9295;
const GRPC_PORT: u16 = 9296;
const GQL_PORT:  u16 = 9297;
...
fn dispatch(tool: []const u8, _body: []const u8, resp: []u8) Response {
    _ = _body;
    if (std.mem.eql(u8, tool, "ums_create_project")) {
        return .{ .status = 200, .body = okJson(resp, "ums_create_project forwarded") };
    }
    if (std.mem.eql(u8, tool, "ums_open_project")) {
        return .{ .status = 200, .body = okJson(resp, "ums_open_project forwarded") };
    }
    if (std.mem.eql(u8, tool, "ums_close_project")) {
        return .{ .status = 200, .body = okJson(resp, "ums_close_project forwarded") };
    }
    if (std.mem.eql(u8, tool, "ums_load_level")) {
        return .{ .status = 200, .body = okJson(resp, "ums_load_level forwarded") };
    }
    if (std.mem.eql(u8, tool, "ums_save_level")) {
        return .{ .status = 200, .body = okJson(resp, "ums_save_level forwarded") };
    }
    if (std.mem.eql(u8, tool, "ums_validate_level")) {
        return .{ .status = 200, .body = okJson(resp, "ums_validate_level forwarded") };
    }
    if (std.mem.eql(u8, tool, "ums_list_profiles")) {
        return .{ .status = 200, .body = okJson(resp, "ums_list_profiles forwarded") };
    }
...
fn dispatchGraphql(body: []const u8, resp: []u8) Response {
    if (std.mem.indexOf(u8, body, "ums_create_project") != null)
        return dispatch("ums_create_project", body, resp);
    if (std.mem.indexOf(u8, body, "ums_open_project") != null)
        return dispatch("ums_open_project", body, resp);
    if (std.mem.indexOf(u8, body, "ums_close_project") != null)
        return dispatch("ums_close_project", body, resp);
    if (std.mem.indexOf(u8, body, "ums_load_level") != null)
        return dispatch("ums_load_level", body, resp);
    if (std.mem.indexOf(u8, body, "ums_save_level") != null)
        return dispatch("ums_save_level", body, resp);
    if (std.mem.indexOf(u8, body, "ums_validate_level") != null)
        return dispatch("ums_validate_level", body, resp);
    if (std.mem.indexOf(u8, body, "ums_list_profiles") != null)
        return dispatch("ums_list_profiles", body, resp);
