...
= feedback-mcp / abi — Idris2 ABI layer
:orientation: shallow

== Purpose

Cartridge-local protocol types for `feedback-mcp`. Defines the data, tool, and
...
1 Idris2 module(s), ~173 lines total. Lead module:
`SafeFeedback.idr`.
...
. `SafeFeedback.idr` — cartridge-local data records and enums.
