...
//
// build.zig — Build configuration for linode-mcp FFI shared library.
...
pub fn build(b: *std.Build) void {
    ...
    const ffi_mod = b.addModule("linode_mcp", .{
        .root_source_file = b.path("linode_mcp_ffi.zig"),
        .target = target,
        .optimize = optimize,
    });
    ...
    const test_step = b.step("test", "Run Linode MCP FFI tests");
