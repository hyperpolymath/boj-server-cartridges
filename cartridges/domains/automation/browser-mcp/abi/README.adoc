...
= browser-mcp / abi — Idris2 ABI layer
:orientation: shallow

== Purpose

Cartridge-local protocol types for `browser-mcp`. Defines the data, tool, and
...
1 Idris2 module(s), ~228 lines total. Lead module:
`SafeBrowser.idr`.
...
. `SafeBrowser.idr` — cartridge-local data records and enums.
