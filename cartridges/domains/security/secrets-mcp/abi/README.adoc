...
= secrets-mcp / abi — Idris2 ABI layer
:orientation: shallow

== Purpose

Cartridge-local protocol types for `secrets-mcp`. Defines the data, tool, and
...
1 Idris2 module(s), ~200 lines total. Lead module:
`SafeSecrets.idr`.
...
. `SafeSecrets.idr` — cartridge-local data records and enums.
