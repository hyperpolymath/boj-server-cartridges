...
= panic-attack-mcp / abi — Idris2 ABI layer
:orientation: shallow

== Purpose

Cartridge-local protocol types for `panic-attack-mcp`. Defines the data, tool, and
...
1 Idris2 module(s), ~55 lines total. Lead module:
`Protocol.idr`.
