...
//
// Proof-MCP Cartridge — Zig FFI build configuration (Zig 0.15+).
...
pub fn build(b: *std.Build) void {
    ...
    const run_tests = b.addRunArtifact(proof_tests);

    const test_step = b.step("test", "Run proof-mcp FFI tests");
