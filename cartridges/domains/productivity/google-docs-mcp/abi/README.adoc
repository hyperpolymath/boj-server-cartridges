...
= google-docs-mcp / abi — Idris2 ABI layer
:orientation: shallow

== Purpose

Cartridge-local protocol types for `google-docs-mcp`. Defines the data, tool, and
...
1 Idris2 module(s), ~179 lines total. Lead module:
`SafeRegistry.idr`.
