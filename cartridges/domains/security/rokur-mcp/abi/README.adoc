...
= rokur-mcp / abi — Idris2 ABI layer
:orientation: shallow

== Purpose

Cartridge-local protocol types for `rokur-mcp`. Defines the data, tool, and
...
1 Idris2 module(s), ~157 lines total. Lead module:
`SafeGate.idr`.
...
. `SafeGate.idr` — cartridge-local data records and enums.
