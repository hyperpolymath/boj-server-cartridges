...
= postgresql-mcp / abi — Idris2 ABI layer
:orientation: shallow

== Purpose

Cartridge-local protocol types for `postgresql-mcp`. Defines the data, tool, and
...
1 Idris2 module(s), ~232 lines total. Lead module:
`SafeDatabase.idr`.
