...
= research-mcp / abi — Idris2 ABI layer
:orientation: shallow

== Purpose

Cartridge-local protocol types for `research-mcp`. Defines the data, tool, and
...
1 Idris2 module(s), ~216 lines total. Lead module:
`SafeResearch.idr`.
...
. `SafeResearch.idr` — cartridge-local data records and enums.
