...
pub fn build(b: *std.Build) void {
    ...
    // Shared ADR-0006 invoke-shim module (canonical copy alongside this file).
    ...
    const ffi_mod = b.addModule("bug_filing_mcp", .{
        .root_source_file = b.path("bug_filing_mcp_ffi.zig"),
        .target = target,
        .optimize = optimize,
    });
