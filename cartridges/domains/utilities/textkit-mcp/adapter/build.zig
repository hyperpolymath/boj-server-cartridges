...
pub fn build(b: *std.Build) void {
    ...
    adapter_mod.addImport("gossamer_ffi", ffi_mod);
    ...
    const run_step = b.step("run", "Run the textkit-mcp adapter");
    ...
    const test_step = b.step("test", "Run textkit-mcp adapter tests");
