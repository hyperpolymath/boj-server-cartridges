...
| `aerie_list_envs` | List all Aerie environments
| `aerie_create_env` | Create a new Aerie environment
| `aerie_destroy_env` | Destroy an Aerie environment
| `aerie_get_status` | Get status of an Aerie environment
|===
