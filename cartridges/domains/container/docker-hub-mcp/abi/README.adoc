...
= docker-hub-mcp / abi — Idris2 ABI layer
:orientation: shallow

== Purpose

Cartridge-local protocol types for `docker-hub-mcp`. Defines the data, tool, and
...
1 Idris2 module(s), ~230 lines total. Lead module:
`SafeContainer.idr`.
...
. `SafeContainer.idr` — cartridge-local data records and enums.
