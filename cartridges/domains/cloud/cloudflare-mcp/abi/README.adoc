...
= cloudflare-mcp / abi — Idris2 ABI layer
:orientation: shallow

== Purpose

Cartridge-local protocol types for `cloudflare-mcp`. Defines the data, tool, and
...
1 Idris2 module(s), ~122 lines total. Lead module:
`SafeCloud.idr`.
