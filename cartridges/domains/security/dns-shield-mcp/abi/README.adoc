...
= dns-shield-mcp / abi — Idris2 ABI layer
:orientation: shallow

== Purpose

Cartridge-local protocol types for `dns-shield-mcp`. Defines the data, tool, and
...
1 Idris2 module(s), ~103 lines total. Lead module:
`SafeDns.idr`.
...
. `SafeDns.idr` — cartridge-local data records and enums.
