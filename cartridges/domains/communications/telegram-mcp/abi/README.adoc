...
= telegram-mcp / abi — Idris2 ABI layer
:orientation: shallow

== Purpose

Cartridge-local protocol types for `telegram-mcp`. Defines the data, tool, and
...
1 Idris2 module(s), ~243 lines total. Lead module:
`SafeComms.idr`.
...
. `SafeComms.idr` — cartridge-local data records and enums.
