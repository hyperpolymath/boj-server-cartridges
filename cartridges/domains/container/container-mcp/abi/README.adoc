...
= container-mcp / abi — Idris2 ABI layer
:orientation: shallow

== Purpose

Cartridge-local protocol types for `container-mcp`. Defines the data, tool, and
...
1 Idris2 module(s), ~178 lines total. Lead module:
`SafeContainer.idr`.
