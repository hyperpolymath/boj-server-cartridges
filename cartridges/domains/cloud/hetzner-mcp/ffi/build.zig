...
//
// build.zig — Build configuration for hetzner-mcp FFI shared library and tests.
...
pub fn build(b: *std.Build) void {
    ...
    const ffi_mod = b.addModule("hetzner_mcp", .{
        .root_source_file = b.path("hetzner_mcp_ffi.zig"),
        .target = target,
        .optimize = optimize,
    });
