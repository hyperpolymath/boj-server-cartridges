...
# Integration tests for github-actions-mcp cartridge.
set -euo pipefail
...
echo "=== github-actions-mcp integration tests ==="
...
if command -v idris2 &>/dev/null; then
    cd "$CART_DIR/abi" && idris2 --check GithubActionsMcp.SafeRegistry 2>&1
    echo "  ABI: OK"
else
...
echo ""
echo "All tests passed for github-actions-mcp!"
