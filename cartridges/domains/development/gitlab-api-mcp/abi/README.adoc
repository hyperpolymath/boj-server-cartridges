...
= gitlab-api-mcp / abi — Idris2 ABI layer
:orientation: shallow

== Purpose

Cartridge-local protocol types for `gitlab-api-mcp`. Defines the data, tool, and
...
1 Idris2 module(s), ~239 lines total. Lead module:
`SafeGit.idr`.
...
. `SafeGit.idr` — cartridge-local data records and enums.
