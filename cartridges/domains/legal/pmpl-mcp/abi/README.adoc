...
Cartridge-local protocol types for `pmpl-mcp`. Defines the data, tool, and
...
1 Idris2 module(s), ~80 lines total. Lead module:
`SafeProvenance.idr`.
...
. `SafeProvenance.idr` — cartridge-local data records and enums.
