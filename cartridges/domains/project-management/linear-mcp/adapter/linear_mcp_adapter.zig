...
const REST_PORT: u16 = 9262;
const GRPC_PORT: u16 = 9263;
const GQL_PORT:  u16 = 9264;
...
fn dispatch(tool: []const u8, _body: []const u8, resp: []u8) Response {
    _ = _body;
    if (std.mem.eql(u8, tool, "linear_authenticate")) {
        return .{ .status = 200, .body = okJson(resp, "linear_authenticate forwarded") };
    }
    if (std.mem.eql(u8, tool, "linear_list_issues")) {
        return .{ .status = 200, .body = okJson(resp, "linear_list_issues forwarded") };
    }
    if (std.mem.eql(u8, tool, "linear_get_issue")) {
        return .{ .status = 200, .body = okJson(resp, "linear_get_issue forwarded") };
    }
    if (std.mem.eql(u8, tool, "linear_create_issue")) {
        return .{ .status = 200, .body = okJson(resp, "linear_create_issue forwarded") };
    }
    if (std.mem.eql(u8, tool, "linear_update_issue")) {
        return .{ .status = 200, .body = okJson(resp, "linear_update_issue forwarded") };
    }
    if (std.mem.eql(u8, tool, "linear_list_teams")) {
        return .{ .status = 200, .body = okJson(resp, "linear_list_teams forwarded") };
    }
    if (std.mem.eql(u8, tool, "linear_search_issues")) {
        return .{ .status = 200, .body = okJson(resp, "linear_search_issues forwarded") };
    }
...
fn dispatchGraphql(body: []const u8, resp: []u8) Response {
    if (std.mem.indexOf(u8, body, "linear_authenticate") != null)
        return dispatch("linear_authenticate", body, resp);
    if (std.mem.indexOf(u8, body, "linear_list_issues") != null)
        return dispatch("linear_list_issues", body, resp);
    if (std.mem.indexOf(u8, body, "linear_get_issue") != null)
        return dispatch("linear_get_issue", body, resp);
    if (std.mem.indexOf(u8, body, "linear_create_issue") != null)
        return dispatch("linear_create_issue", body, resp);
    if (std.mem.indexOf(u8, body, "linear_update_issue") != null)
        return dispatch("linear_update_issue", body, resp);
    if (std.mem.indexOf(u8, body, "linear_list_teams") != null)
        return dispatch("linear_list_teams", body, resp);
    if (std.mem.indexOf(u8, body, "linear_search_issues") != null)
        return dispatch("linear_search_issues", body, resp);
