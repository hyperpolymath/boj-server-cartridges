...
= ums-mcp / abi — Idris2 ABI layer
:orientation: shallow

== Purpose

Cartridge-local protocol types for `ums-mcp`. Defines the data, tool, and
...
1 Idris2 module(s), ~256 lines total. Lead module:
`SafeUms.idr`.
...
. `SafeUms.idr` — cartridge-local data records and enums.
