...
= game-admin-mcp / abi — Idris2 ABI layer
:orientation: shallow

== Purpose

Cartridge-local protocol types for `game-admin-mcp`. Defines the data, tool, and
...
1 Idris2 module(s), ~81 lines total. Lead module:
`Protocol.idr`.
