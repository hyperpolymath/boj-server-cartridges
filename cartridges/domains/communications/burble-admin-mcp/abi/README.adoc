...
= burble-admin-mcp / abi — Idris2 ABI layer
:orientation: shallow

== Purpose

Cartridge-local protocol types for `burble-admin-mcp`. Defines the data, tool, and
...
1 Idris2 module(s), ~83 lines total. Lead module:
`Protocol.idr`.
