...
= dap-mcp / abi — Idris2 ABI layer
:orientation: shallow

== Purpose

Cartridge-local protocol types for `dap-mcp`. Defines the data, tool, and
...
1 Idris2 module(s), ~193 lines total. Lead module:
`SafeDap.idr`.
...
. `SafeDap.idr` — cartridge-local data records and enums.
