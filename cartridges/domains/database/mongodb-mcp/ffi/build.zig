...
//
// build.zig -- Build configuration for mongodb-mcp FFI shared library.
//
// Links against libmongoc and libbson for MongoDB wire protocol and BSON support.
// Produces libmongodb_mcp.so/.dylib/.dll for zig adapter consumption.
