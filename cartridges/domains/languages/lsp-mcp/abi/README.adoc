...
= lsp-mcp / abi — Idris2 ABI layer
:orientation: shallow

== Purpose

Cartridge-local protocol types for `lsp-mcp`. Defines the data, tool, and
...
1 Idris2 module(s), ~187 lines total. Lead module:
`SafeLsp.idr`.
...
. `SafeLsp.idr` — cartridge-local data records and enums.
