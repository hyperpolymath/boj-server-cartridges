...
= clickhouse-mcp / abi — Idris2 ABI layer
:orientation: shallow

== Purpose

Cartridge-local protocol types for `clickhouse-mcp`. Defines the data, tool, and
...
1 Idris2 module(s), ~167 lines total. Lead module:
`SafeDatabase.idr`.
...
. `SafeDatabase.idr` — cartridge-local data records and enums.
