...
# Integration tests for obsidian-mcp cartridge.
set -euo pipefail
...
echo "=== obsidian-mcp integration tests ==="
...
if command -v idris2 &>/dev/null; then
    cd "$CART_DIR/abi" && idris2 --check ObsidianMcp.SafeRegistry 2>&1
    echo "  ABI: OK"
else
...
echo ""
echo "All tests passed for obsidian-mcp!"
