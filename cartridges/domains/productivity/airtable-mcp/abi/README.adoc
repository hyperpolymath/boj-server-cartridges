...
= airtable-mcp / abi — Idris2 ABI layer
:orientation: shallow

== Purpose

Cartridge-local protocol types for `airtable-mcp`. Defines the data, tool, and
...
1 Idris2 module(s), ~166 lines total. Lead module:
`SafeRegistry.idr`.
