...
= k8s-mcp / abi — Idris2 ABI layer
:orientation: shallow

== Purpose

Cartridge-local protocol types for `k8s-mcp`. Defines the data, tool, and
...
1 Idris2 module(s), ~181 lines total. Lead module:
`SafeK8s.idr`.
...
. `SafeK8s.idr` — cartridge-local data records and enums.
