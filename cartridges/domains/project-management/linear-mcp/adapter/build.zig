...
pub fn build(b: *std.Build) void {
    ...
    adapter_mod.addImport("linear_mcp_ffi", ffi_mod);
    ...
    const run_step = b.step("run", "Run the linear-mcp adapter");
    ...
    const test_step = b.step("test", "Run linear-mcp adapter tests");
