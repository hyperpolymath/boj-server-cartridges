...
= observe-mcp / abi — Idris2 ABI layer
:orientation: shallow

== Purpose

Cartridge-local protocol types for `observe-mcp`. Defines the data, tool, and
...
1 Idris2 module(s), ~156 lines total. Lead module:
`SafeObserve.idr`.
...
. `SafeObserve.idr` — cartridge-local data records and enums.
