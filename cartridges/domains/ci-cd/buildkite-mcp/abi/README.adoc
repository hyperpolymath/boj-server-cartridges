...
= buildkite-mcp / abi — Idris2 ABI layer
:orientation: shallow

== Purpose

Cartridge-local protocol types for `buildkite-mcp`. Defines the data, tool, and
...
1 Idris2 module(s), ~153 lines total. Lead module:
`SafeRegistry.idr`.
