...
pub export fn panic_attack_scan(target: [*c]const u8) u32 {
...
pub export fn panic_attack_get_findings_count(scan_id: u32) u32 {
    if (scan_id == 0) return 0;
    return 0; // Stub
}

/// Get the highest severity found in a scan.
pub export fn panic_attack_get_severity(scan_id: u32) u8 {
