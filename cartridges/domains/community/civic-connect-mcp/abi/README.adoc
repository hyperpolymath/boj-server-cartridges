...
= civic-connect-mcp / abi — Idris2 ABI layer
:orientation: shallow

== Purpose

Cartridge-local protocol types for `civic-connect-mcp`. Defines the data, tool, and
...
1 Idris2 module(s), ~50 lines total. Lead module:
`Protocol.idr`.
