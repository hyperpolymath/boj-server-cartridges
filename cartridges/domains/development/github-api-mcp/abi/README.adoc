...
= github-api-mcp / abi — Idris2 ABI layer
:orientation: shallow

== Purpose

Cartridge-local protocol types for `github-api-mcp`. Defines the data, tool, and
...
1 Idris2 module(s), ~257 lines total. Lead module:
`SafeGit.idr`.
