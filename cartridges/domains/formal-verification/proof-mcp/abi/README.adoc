...
= proof-mcp / abi — Idris2 ABI layer
:orientation: shallow

== Purpose

Cartridge-local protocol types for `proof-mcp`. Defines the data, tool, and
...
1 Idris2 module(s), ~226 lines total. Lead module:
`SafeProof.idr`.
...
. `SafeProof.idr` — cartridge-local data records and enums.
