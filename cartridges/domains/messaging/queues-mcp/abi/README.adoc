...
= queues-mcp / abi — Idris2 ABI layer
:orientation: shallow

== Purpose

Cartridge-local protocol types for `queues-mcp`. Defines the data, tool, and
...
1 Idris2 module(s), ~197 lines total. Lead module:
`SafeQueues.idr`.
...
. `SafeQueues.idr` — cartridge-local data records and enums.
