...
= supabase-mcp / abi — Idris2 ABI layer
:orientation: shallow

== Purpose

Cartridge-local protocol types for `supabase-mcp`. Defines the data, tool, and
...
1 Idris2 module(s), ~172 lines total. Lead module:
`SafeDatabase.idr`.
