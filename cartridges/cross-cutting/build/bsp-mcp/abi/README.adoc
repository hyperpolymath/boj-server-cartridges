...
= bsp-mcp / abi — Idris2 ABI layer
:orientation: shallow

== Purpose

Cartridge-local protocol types for `bsp-mcp`. Defines the data, tool, and
...
1 Idris2 module(s), ~214 lines total. Lead module:
`SafeBsp.idr`.
...
. `SafeBsp.idr` — cartridge-local data records and enums.
