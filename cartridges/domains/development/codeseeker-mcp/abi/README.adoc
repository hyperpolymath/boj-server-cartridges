...
= codeseeker-mcp / abi — Idris2 ABI layer
:orientation: shallow

== Purpose

Cartridge-local protocol types for `codeseeker-mcp`. Defines the data, tool, and
...
1 Idris2 module(s), ~238 lines total. Lead module:
`SearchGraph.idr`.
...
. `SearchGraph.idr` — cartridge-local data records and enums.
